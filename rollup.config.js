...
export default [
	createEsmBundle('src/index-full.js', 'index.mjs',       babelModern),
	createUmdBundle('src/index-full.js', 'index.cjs',        babelModern),
	createUmdBundle('src/index-full.js', 'index.legacy.cjs', babelLegacy),
